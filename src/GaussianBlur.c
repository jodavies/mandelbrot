...
/*			image[j*xRes*3 + i*3 + 0] = (+1.0*imageCopy[(j+1)*xRes*3 + (i+1)*3 + 0]
			...
			image[j*xRes*3 + i*3 + 0] = (   +1.0*imageCopy[(j+1)*xRes*3 + (i+0)*3 + 0]
                                         +1.0*imageCopy[(j+0)*xRes*3 + (i+1)*3 + 0]
                                         +4.0*imageCopy[(j+0)*xRes*3 + (i+0)*3 + 0]
                                         +1.0*imageCopy[(j+0)*xRes*3 + (i-1)*3 + 0]
                                         +1.0*imageCopy[(j-1)*xRes*3 + (i+0)*3 + 0])/8.0;
			image[j*xRes*3 + i*3 + 1] = (   +1.0*imageCopy[(j+1)*xRes*3 + (i+0)*3 + 1]
                                         +1.0*imageCopy[(j+0)*xRes*3 + (i+1)*3 + 1]
                                         +4.0*imageCopy[(j+0)*xRes*3 + (i+0)*3 + 1]
                                         +1.0*imageCopy[(j+0)*xRes*3 + (i-1)*3 + 1]
                                         +1.0*imageCopy[(j-1)*xRes*3 + (i+0)*3 + 1])/8.0;
			image[j*xRes*3 + i*3 + 2] = (   +1.0*imageCopy[(j+1)*xRes*3 + (i+0)*3 + 2]
                                         +1.0*imageCopy[(j+0)*xRes*3 + (i+1)*3 + 2]
                                         +4.0*imageCopy[(j+0)*xRes*3 + (i+0)*3 + 2]
                                         +1.0*imageCopy[(j+0)*xRes*3 + (i-1)*3 + 2]
                                         +1.0*imageCopy[(j-1)*xRes*3 + (i+0)*3 + 2])/8.0;
		}
	}
